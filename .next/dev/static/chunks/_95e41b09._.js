...
"[project]/services/storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/services/alertService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/storage.ts [app-client] (ecmascript)");
;
const alertService = {
    /**
   * Check if current analysis should trigger an alert
   */ checkThresholds (analysis) {
        const thresholds = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getAlertThresholds();
   ...
   */ getRecipients (alertType) {
        const caregivers = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getCaregivers();
...
"[project]/views/Settings.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/storage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$alertService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/alertService.ts [app-client] (ecmascript)");
...
const Settings = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Settings.useEffect": ()=>{
            ...
            const currentThresholds = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getAlertThresholds();
            if (!localStorage.getItem('altrea_alert_thresholds')) {
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].saveAlertThresholds(currentThresholds);
            }
        }
    }["Settings.useEffect"], []);
    const loadData = ()=>{
        const loadedCaregivers = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getCaregivers();
        const loadedThresholds = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].getAlertThresholds();
    ...
    const handleSaveCaregiver = ()=>{
        ...
        try {
            if (editingId) {
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].updateCaregiver(editingId, formData);
                toast({
                    title: 'Caregiver Updated',
                    description: `${formData.name} has been updated successfully.`
                });
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].addCaregiver(formData);
                toast({
    ...
    const handleDeleteCaregiver = (id)=>{
        ...
        if (caregiver && window.confirm(`Are you sure you want to remove ${caregiver.name}?`)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].deleteCaregiver(id);
            toast({
    ...
    const handleSetPrimary = (id)=>{
        ...
        updated.forEach((c)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].updateCaregiver(c.id, {
    ...
    const handleThresholdChange = (key, value)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].saveAlertThresholds(newThresholds);
        toast({
    ...
    const handleTestAlert = async (type)=>{
        const recipients = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$alertService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alertService"].getRecipients(type);
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: caregivers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            columnNumber: 17
                                                ...
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('p-4', caregiver.isPrimary && 'ring-2 ring-primary/20'),
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Settings, "foC2ZvcDHL7UrEGMNnC0kLxOWtE=", false, function() {
    return [
...
"[project]/app/settings/page.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$views$2f$Settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/views/Settings.tsx [app-client] (ecmascript)");
"use client";
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
__turbopack_context__.s([
    "default",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$views$2f$Settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$settings$2f$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/app/settings/page.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$views$2f$Settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/views/Settings.tsx [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=_95e41b09._.js.map